...
const FooterWidget = (props) => {
    return (
        <WidgetWrapper {...props} bg="black" py={[60, 60, 100]}>
            <Container>
                <Row>
                    <Col md={12} lg={6}>
                        <Widget title="ABOUT US" mb={[30, null, null, 0]}>
                            <p className="about-text">
                                Flight Simulator Factory is a global online
                                store for flight simulation products and
                                software. We are proud to offer the largest
                                selection of quality flight simulation products
                                in the world.
                            </p>
